...
export default function PaymentCancelledDialog({
  ...
  return (
    <div className="fixed inset-0 z-[999]">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-2xl max-w-md mx-auto w-full border-t-4 border-black animate-slide-up h-[90vh] sm:h-auto overflow-hidden flex flex-col z-[1000]">
