  ...
  const fabContent = (
    <div className="fixed bottom-6 right-6 z-50 pointer-events-none">
      <button
        ...
        className="fab w-14 h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-200 active:scale-95 pointer-events-auto"
        aria-label="Chat on WhatsApp"
      >
        <MessageCircle className="w-6 h-6" />
      </button>
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-96 max-w-md pointer-events-auto">
